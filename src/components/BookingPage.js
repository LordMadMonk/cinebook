...
const BookingPage = () => {
    ...
    const{movieId, movieName, movieDescription, movieDate, movieHours, movieRating}=useParams();
            ...
            <div className='Slider'>
                <Carousel>
                    ...
                    <Carousel.Item className='slider2' interval={500}>
                        ...
                        <Carousel.Caption>
                            <h3>Your Safety is our Priority</h3>
                            <p>Please remember to sanatize your hands at regular intervals</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    ...
                    <Carousel.Item className='slider3' interval={500}>
                        ...
                        <Carousel.Caption>
                            <h3>Your Safety is our Priority</h3>
                            <p>Please remember to Maintain Social Distancing while selecting seats</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                </Carousel>
            </div>
...
<br/>
            ...
            <div key={items.showId}>
                <Button variant='contained' sx={{mb:2}} type="submit" onClick={() => navigate(`/seatsel/${movieId}/${item.theatreId}/${item.theatreName}/${items.showId}/${items.showStartTime}/${items.showDate}`)}>{items.showStartTime}</Button>
            </div> 
            ))}
                </div>
            )}
